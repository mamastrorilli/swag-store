      ...
      <div className="container mx-auto px-4 py-10">
        <div className="flex flex-col gap-6 md:flex-row md:justify-between">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Badge
              variant="outline"
              className="w-fit border-gray-200 text-gray-400 text-xs"
            >
              Powered by Next.js
            </Badge>
          </div>
          ...
          <div className="flex gap-12 text-sm flex-wrap">
            <div className="flex flex-col gap-2">
              ...
              <Link
                href={store.socialLinks.github}
                className="hover:text-white transition-colors"
              >
                GitHub
              </Link>
              <Link
                href={store.socialLinks.discord}
                className="hover:text-white transition-colors"
              >
                Discord
              </Link>
        ...
        <p className="text-xs text-gray-400 text-center">
          © {new Date().getFullYear()} {store.storeName}. Built with Next.js &
          Vercel.
        </p>
      </div>
    </footer>
